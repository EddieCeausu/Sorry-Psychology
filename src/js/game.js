...
var movesMade = 0;
var images = {
  blue: "src/tools/gfx/blue-piece.jpg",
  startBlue0: "src/tools/gfx/blue-start-empty.png",
  startBlue1: "src/tools/gfx/blue-start-one.png",
  startBlue2: "src/tools/gfx/blue-start-two.png",
  startBlue3: "src/tools/gfx/blue-start-three.png",
  red: "src/tools/gfx/red-piece.jpg",
  startRed0: "src/tools/gfx/red-start-empty.png",
  startRed1: "src/tools/gfx/red-start-one.png",
  startRed3: "src/tools/gfx/red-start-three.png",
...
function questionGetter() {
  ...
  if (questions[rand].includes("::")) {
    a = questions[rand];
    q = questions[rand - 1];
    questions.splice(rand - 1, 2);
    console.log(q, '\n', a);
  } else {
    q = questions[rand];
    a = questions[rand + 1]
    questions.splice(rand, 2);
    console.log(q, '\n', a);
  }
  answered.unshift(q, a);
  ...
  return {
    question: q.slice(0, i - 1).toString(),
    option: options,
...
function changePreviousQuestion(dic, response) {
  ...
  for (var i = 0; i < dic.option.length; i++) {
    if (answers[i] == dic.answer) {
      // console.log("answers[i] == dic.answer");
      str += `\u2714 ${dic.option[i]} <br />`;
    } else if (uResponse == dic.option[i]) {
      // console.log("uResponse == dic.option[i]");
      str += `\u2718 ${dic.option[i]} <br />`;
    } else {
  ...
  if (response == dic.answer) {
    str += "<br />" + "CORRECT!!!"
  } else {
    str += "<br />" + "INCORRECT :(<br />Correct answer is: " + answer;
  }
